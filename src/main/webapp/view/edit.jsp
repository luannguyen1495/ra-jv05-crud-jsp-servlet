...
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="text-center text-danger">Cập nhật nhân viên </h1>
            <form action="<%=request.getContextPath()%>/nhan-vien" method="POST">
                <div class="form-group">
                    <label for="exampleInputEmail1">Mã Nhân viên</label>
                    <input type="text" class="form-control" value="${employee.employeeCode}" id="exampleInputEmail1" readonly name="employeeCode">
                </div>
                <div class="form-group">
